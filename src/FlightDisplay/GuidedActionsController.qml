...
Item {
    ...
    readonly property string ptcTitle:                      qsTr("PTC")
    readonly property string dayIRTitle:                    qsTr("Day / IR")
    readonly property string obsTitle:                      qsTr("OBS")
    readonly property string grrTitle:                      qsTr("GRR")
    ...
    readonly property int actionPtc:                        22
    readonly property int actionDayIR:                      23
    readonly property int actionObs:                        24
    readonly property int actionGrr:                        25
